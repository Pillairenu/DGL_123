  ...
  <main>
    ...
    <div class="main-container">
      <div class="rooms-container">
        <h1> Discover Your Ideal Apartments</h1>
            <article class="article-container">
                <div class="image">
                    <img src="images/room-1.jpeg" alt="Image">
                </div>
                <div class="content">
                    <h2>Apartments available in 15th Street, Courtenay</h2>
                    ...
                    <a href="/DGL_123/milestone_3/room-details" class="details-button">View Details</a>
                </div>
            </article>
            <article class="article-container">
                <div class="image">
                ...
                <div class="content">
                    <h2>Apartments available in Comox Avenue</h2>
            ...
            <article class="article-container">
                ...
                <div class="content">
                    <h2>Apartments available in Port Augusta Street</h2>
